...
class BasicModel(torch.nn.Module):
    def __init__(self, opt):
        ...
        self.domain_hypernet = MultiLayerPerceptron(self.dnn_dim, self.embed_dims, output_layer=False,
...
class MaskDNN(BasicModel):
    ...
    def forward(self, x, d):
        ...
        logit2 = output_dnn2
        logit3 = output_dnn3
        return logit1, logit2, logit3, smask
