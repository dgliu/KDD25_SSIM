...
import numpy as np
from modules import hmoe_SSIM4
...
parser.add_argument("--scenes", type=int, nargs='+', default=[0, 1, 2, 3], help="scenes")
parser.add_argument("--activation", type=str, default='relu', help="activation")
parser.add_argument("--share_units", type=int, nargs='+', default=[128], help="share mlp layer size")
parser.add_argument("--share_dropout", type=float, default=[0.1], help="share mlp dropout rate")
parser.add_argument("--tower_units", type=int, nargs='+', default=[16], help="tower_units layer size")
parser.add_argument("--tower_dropout", type=float, default=[0.3], help="tower_dropout rate")
...
parser.add_argument("--lambda1", type=float, default=0.1, help="lambda")
...
class Trainer(object):
    def __init__(self, opt):
        ...
        self.model = hmoe_SSIM4.HMoE(opt['model_opt'])
        self.model_opt = hmoe_SSIM4.HMoE_OPT()
        self.model_eval = hmoe_SSIM4.HMoE_Eval()
    ...
    def train(self, epochs):
        self.model = hmoe_SSIM4.HMoE(self.opt['model_opt'])
        ...
        self.model_mask = hmoe_SSIM4.HMoE(self.opt['model_opt'])
