...
import numpy as np
from modules import star_SSIM3
...
parser.add_argument("--lambda1", type=float, default=0.3, help="lambda")
...
class Trainer(object):
    def __init__(self, opt):
        ...
        self.model = star_SSIM3.STAR(opt['model_opt'])
        self.model_opt = star_SSIM3.STAR_OPT()
        self.model_eval = star_SSIM3.STAR_Eval()
    ...
    def train(self, epochs):
        self.model = star_SSIM3.STAR(self.opt['model_opt'])
        ...
        self.model_mask = star_SSIM3.STAR(self.opt['model_opt'])
